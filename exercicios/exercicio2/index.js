...
function removerLivroDoEstoque(idDoDlivro){
    const existeIdNoEstoque = !!livrosDisponiveis.find(livro => livro.id === idDoLivro)
...
function quantidadeDeLivros(id, novaQuantidade){
    ...
    for(let livro of livrosDisponiveis){
        ...
        console.log(`a quantidade do ${livro.titulo} foi atualizada para ${novaQuantidade} livros`)
        }
    }   
    }
    else {
